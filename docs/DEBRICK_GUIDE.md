...
Grâce à l'architecture du processeur Allwinner A523, la tablette est récupérable via le **Mode FEL** matériel 🛠️.
...
### 🅰️ Scénario A : Vous avez corrompu la partition `boot` (Noyau/Recovery)
...
### 🅱️ Scénario B : La table de partitions (GPT) est détruite
...
1. ⬇️ Téléchargez `super.img.zst` depuis les "Releases" GitHub de ce dépôt.
