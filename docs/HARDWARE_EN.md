...
## Main Features
- **Brand (Build)**: PCBOX / Digiland
- **Model**: PCB-T106 / S10
- **SoC (Processor)**: Allwinner A523 (sun55iw3p1 / Saturn)
- **CPU Architecture**: Octa-core 64-bit (`arm64-v8a`)
...
The folders (`reference/` in this repository) contain the full hardware reports for reverse engineering:
- `t106-dmesg.txt`: Kernel logs at boot
- `t106-lsmod.txt`: List of loaded modules/drivers
