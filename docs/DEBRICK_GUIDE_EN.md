...
[🇫🇷 Lire en Français](DEBRICK_GUIDE.md)
...
Thanks to the Allwinner A523 processor architecture, the tablet is recoverable via the hardware **FEL Mode**.
...
### Scenario A: You corrupted the `boot` partition (Kernel/Recovery)
...
### Scenario B: The partition table (GPT) is destroyed
...
1. Download `super.img.zst` from the GitHub "Releases" of this repository.
