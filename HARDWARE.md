...
- **Marque (Build)** : PCBOX / Digiland
- **Modèle** : PCB-T106 / S10
- **SoC (Processeur)** : Allwinner A523 (sun55iw3p1 / Saturn)
- **Architecture CPU** : Octa-core 64-bit (`arm64-v8a`)
...
Ces dossiers (`reference/` dans ce dépôt) contiennent les rapports matériels complets pour la rétro-ingénierie :
- `t106-dmesg.txt` : Logs du noyau au démarrage
- `t106-lsmod.txt` : Liste des modules/pilotes chargés
